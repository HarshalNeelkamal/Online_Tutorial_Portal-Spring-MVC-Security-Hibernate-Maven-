...
<form:form action="addTutorial" modelAttribute="TutorialModel" method="post">
	<table>
		<tr>
			<td>title:</td>
			<td><form:input type="text" path="tut_title"/></td>
			<td align="right"><form:errors path="tut_title" cssClass="error"/> </td>
		</tr>
		<tr>
			<td>Description:</td>
			<td><form:textarea type="text" path="Description" id="descriptionInput"/></td>
			<td align="right"><form:errors path="Description" cssClass="error"/> </td>
		</tr>
		<tr>
			<td></td>
