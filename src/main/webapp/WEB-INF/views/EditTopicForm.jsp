...
function formValidation() {
    if (document.forms["topicForm"]["title"].value !== ""){
...
<div>
<form action="editTopicAttempt" method="post" id="topicForm">
<table id="edit_table">
<tr>
...
<tr>
<td><input type="hidden" value="${topicId}" name="topicId"/></td>
</tr>
<tr>
<td><input type="hidden" value="${tutorialId}" name="tutorialId"/></td>
</tr>
</table>
<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
</form>
